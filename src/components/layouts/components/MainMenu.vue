...
<template>
  <div class="flex justify-content-center">
    <Button icon="pi pi-bell" text severity="secondary" @click="toggleAside">
      <svg aria-hidden="true" class="w-6 h-6" fill="var(--p-button-text-plain-color)" viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd"
          d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z">
        </path>
      </svg>
      <svg aria-hidden="true" class="hidden w-6 h-6" fill="var(--p-button-primary-color)" viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg">
      ...
      <template #container="{ closeCallback }">
        <div class="flex flex-col h-full">
          ...
          <div class="flex items-center justify-between px-4 pt-3 flex-shrink-0">
            ...
            <span>
              <Button icon="pi pi-times" @click="closeCallback" class="w-7 h-7" pt:icon:class="text-xs" rounded outlined
